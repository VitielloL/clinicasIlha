...
class HomeController extends Controller
{
        ...
        public function buscar(Request $request)
    {
        ...
        if ($request->filled('nome_profissional') || $request->filled('nome_cliente') || $request->filled('sala') || $request->filled('frequencia')) {
            ...
            $query = Consulta::whereDate('data_consulta', $dataAtual);
            ...
            // Se nenhum parâmetro de busca foi fornecido, recuperar todos os dados paginados do dia atual
            $dados = Consulta::whereDate('data_consulta', $dataAtual)
                            ->paginate(10); // Paginar os dados
        }
